app.controller('GroupActualExpenseNewItemController', [
   '$scope',
   'CommonService',
   'GroupService',
   '$location',
   function(scope,
            ...
            group_service,
            location) {
      common_service.setPageTitle('Group Expense - Actual - Add Item');
      scope.view = {};
      scope.view.item = {};
      ...
      scope.submit = function (form) {
         if (form.$valid) {
            group_service.addActualExpenseItem(scope.view.item);
         } else {
